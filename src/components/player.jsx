...
function Player() {
  ...
  const { addFavorite, removeFavorite, favoriteSongs } =
  ...
  const updateProgress = useCallback(() => {
    if (!audioRef.current.duration) return; // Ensure duration is available
    const progress =
  ...
  const albumImage =
    currentSong && currentSong.album ? currentSong.album.cover_xl : "";
  const artistName =
    currentSong && currentSong.artist ? currentSong.artist.name : "";
      ...
      <div className={`player ${hasPlayedSong ? "show" : ""}`}>
        ...
        >
          <div className="player__info" onClick={toggleControlsExpanded}>
            <div className="player__info-cover">
              {albumImage && (
                <img
                  src={albumImage}
                  alt="Album"
                  className="player__info-album-image"
                />
              )}
            </div>
            <div className="player__info-details">
              {songTitle && (
                <p className="player__info-song-title" ref={titleRef}>
                  {songTitle}
                </p>
              )}
              {artistName && (
                <p className="player__info-artist-name">
                  <Link
            ...
            <button
              className={`player__favorite ${isFavorite ? "active" : ""}`}
              onClick={toggleFavorite}
            >
              {isFavorite ? (
                <HeartFill className="player__favorite-icon-mobile--active" />
              ) : (
                <Heart className="player__favorite-icon-mobile" />
              )}
            </button>
          </div>
          ...
          <div className="player__controls">
            {hasPlayedSong && (
              <div className="player__buttons">
                ...
                >
                  {isFavorite ? (
                    <HeartFill className="player__favorite-icon--active" />
                  ) : (
